// -----------------------------------------------------------------------
// <copyright file="CircularBufferPropertyTests.cs" company="Petabridge, LLC">
    ...
    public class CircularBufferSpecs
    {
            ...
            int[] itemsToAdd)
        {
            for (var i = 0; i < itemsToAdd.Length; i++)
            {
                ...
                if (dequeue != itemsToAdd[i]) return false.When(buffer.Capacity > 0).Label($"Failed with {buffer}");
            }
